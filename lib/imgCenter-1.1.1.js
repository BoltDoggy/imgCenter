(function(w) {
  ...
  function imgBolt(e) {
    if (!e.dataset || e.dataset.imgcenter != 'exception') {
      var eStyle = e.style;
      ...
      time.onload = function () {
        eStyle.backgroundSize = (timg.width / timg.height < e.width / e.height) ? "100% auto" : "auto 100%";
        eStyle.backgroundPosition = 'center';
        eStyle.backgroundImage = 'url(' + timg.src + ')';
      }
      
      e.src = glassy;
      e.setAttribute('data-imgCenter', 'exception');
    }
  }
